...
%changelog
* Wed Jul 22 2026 Michal Josef Špaček <mspacek@redhat.com> - 2.38-5
- Fix CVE-2026-9538: Denial of Service via crafted tar header with large entry size
  Resolves: RHEL-191908

* Tue Jun 16 2026 Michal Josef Špaček <mspacek@redhat.com> - 2.38-4
- Fix CVE-2026-42496: validate symlink and hardlink targets in secure
  extract mode
  Resolves: RHEL-181655
